...
<div class="wrap">
    ...
    <table>
    	...
    	<tr>
    	<td style="font-size:20px;"><b>Cauta un profesor</b></td>
...
<%-- 			<td><%=profesor.getMarca() %></td> --%>
    ...
    <p style="font-size:20px;"><%=request.getAttribute("notFound")%></p>
    <%}%>
    ...
    <table>
    	...
    	<td style="font-size:20px;"><b>Grad didactic</b></td>
    	<td>
    		<select name="titulatura" id="titulatura_prof" style="font-size:20px;">
    ...
    <p style="font-size:20px;"><%=request.getAttribute("incomplet")%></p>
    <%}%></td></tr>
    <tr><td>
    <%if(request.getAttribute("exista")!=null){%>
    <p style="font-size:20px;"><%=request.getAttribute("exista")%></p>
    <%}%>
    </td></tr>
    </table>
    </form>
