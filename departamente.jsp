...
<%int i=1;List<Departament> listaDepartamente=PrelucrariDB.returnDepartamente(); %>
	<%for(Departament departament: listaDepartamente){ %>
		<tr id="dep<%=i%>">
			...
			<td align="center"><button type="button" name="modifica" id="modifica" value="<%=departament.getCod_departament() %>" onclick="updateFunction(this,<%=i%>)"><img src="C:\eclipse\Workspace\update-icon.png" alt="modifica" height="20" width="20"/></button></td>
...
<button type="button" id="inapoi" onclick="location.href = 'admin.jsp';"><img src="C:\eclipse\Workspace\back-icon.png" alt="inapoi" height="20" width="20" /></button>
